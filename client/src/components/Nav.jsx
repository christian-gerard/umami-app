        ...
        <>
            {
                ...
                {viewMenu && (
                    ...
                    <div className='fixed inset-0 transition-colors backdrop-blur flex justify-center items-center'>
                        <div className='w-[70%] h-[30%] sm:hidden flex flex-col bg-shittake text-white z-10 gap-4 italic tracking-widest pl-6 pb-2 rounded-lg '>
